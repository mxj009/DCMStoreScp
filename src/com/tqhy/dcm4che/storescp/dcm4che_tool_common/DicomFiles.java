...
package com.tqhy.dcm4che.storescp.dcm4che_tool_common;
...
public abstract class DicomFiles {
    ...
    public static void scan(List<File> files, Callback scb) {
        scan(files, true, scb); //default printout = true
    }
    
    public static void scan(List<File> files, boolean printout, Callback scb) {
        for (File file : files){
            scan(file, printout, scb);
        }
    }
